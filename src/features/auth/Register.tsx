    ...
    return (
        <Card className="w-full max-w-sm border-(--border-primary) bg-(--bg-secondary) shadow-lg">
            ...
            <CardContent className="space-y-4">
                <Button variant="outline" className="w-full bg-(--bg-primary) text-(--text-primary) border-(--border-primary) hover:bg-(--bg-tertiary)" type="button">
            ...
            <form onSubmit={handleRegister}>
                ...
                <CardFooter className="flex flex-col gap-4 pt-4">
                    <Button
                        className="w-full bg-(--btn-primary-bg) text-(--btn-primary-text) hover:bg-(--btn-primary-hover)"
                        type="submit"
                        disabled={isLoading}
                    >
