                ...
                <CommandEmpty className="py-12 text-center text-sm">
                    {isLoading ? (
                        ...
                        <div className="flex flex-col items-center justify-center gap-2">
                            ...
                            <p className="text-(--text-tertiary)">We couldn't find any results for "{query}"</p>
                        </div>
                    ) : (
                        <div className="flex flex-col items-center justify-center gap-2">
                            <p className="text-(--text-primary) font-semibold text-base">Search for problems</p>
                            <p className="text-(--text-tertiary)">Find coding challenges by title, tags, or difficulty</p>
                        </div>
                    )}
                </CommandEmpty>
                        ...
                        {results.map((problem) => (
                            ...
                            >
                                ...
                                <div className="shrink-0">
                                    <span
                                        className={`inline-flex items-center justify-center px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider rounded border ${problem.difficulty === "EASY"
