  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 max-w-4xl mx-auto w-full gap-5 md:gap-6 mt-8 md:mt-0">
        ...
        <motion.div
          {...up(0)}
          className="flex flex-col sm:flex-row items-center gap-3 md:gap-2.5"
        >
        ...
        <motion.div
          ...
          variants={{
            hidden: {},
            show: {
              transition: { staggerChildren: 0.08, delayChildren: 0.78 },
            },
          }}
        >
          {features.map((f) => (
        ...
        <motion.div
          ...
          variants={{
            hidden: {},
            show: {
              transition: { staggerChildren: 0.045, delayChildren: 1.0 },
            },
          }}
          className="flex flex-col items-center gap-2.5 w-full mt-4 md:mt-2"
        >
          <div
            className="w-32 md:w-40 h-px"
            style={{ background: "var(--border-primary)", opacity: 0.4 }}
          />
          <span
