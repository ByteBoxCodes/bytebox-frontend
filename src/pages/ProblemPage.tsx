...
export default function ProblemPage() {
  ...
  const { data: problems, isLoading: isProblemsLoading } =
    useGetProblemsByTopicId(selectedTopicId);
  ...
  const activeTopicName =
    topics?.find((t) => String(t.id) === selectedTopicId)?.name || "All";
  ...
  return (
    <div
      className="relative lg:h-full min-h-0 flex flex-col overflow-hidden transition-colors duration-200
    ...
    >
      ...
      <div className="relative z-10 px-4 w-full sm:px-6 lg:px-6 py-8 flex-1 overflow-y-auto lg:overflow-hidden">
        <div className="flex flex-col lg:flex-row gap-4 lg:gap-0 h-auto lg:h-full">
          ...
          <div
            className="flex-1 space-y-6 lg:px-8 min-h-[300px] lg:h-full overflow-visible lg:overflow-y-auto min-w-0
